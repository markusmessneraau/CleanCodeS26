...
class ReportFormatterTest {
    ...
    void shouldReturnCorrectPrefixForHeadingLevels(int level, String expectedPrefix) {
    ...
    void shouldReturnCorrectIndentationDashes(int depth, String expectedIndentation) {
        assertEquals(expectedIndentation, formatter.getIndentation(depth));
    }

    @Test
    void shouldFormatBrokenLinkCorrectlyAtRootDepth() {
    ...
    @Test
    void shouldIndentBrokenLinkAtLowerDepth() {
